  ...
  <div class="services-grid">
    ...
    <div class="service-card">
      ...
      <ul>
        ...
        <li>Feasibility discussions</li>
        <li>Team capability planning</li>
      </ul>
    </div>
    ...
    <div class="service-card">
      ...
      <ul>
        ...
        <li>Component selection and provisioning</li>
        <li>Team onboarding and handoff</li>
      </ul>
    </div>
    ...
    <div class="service-card">
      ...
      <ul>
        ...
        <li>Data import and export pipelines</li>
        <li>SSO and identity provider setup</li>
      </ul>
    </div>
    ...
    <div class="service-card">
      ...
      <ul>
        ...
        <li>Role and permission customizations</li>
        <li>Workflow automation and triggers</li>
      </ul>
    </div>
    ...
    <div class="service-card">
      ...
      <ul>
        ...
        <li>Security patching and configuration reviews</li>
      </ul>
    </div>
    ...
    <div class="service-card">
      ...
      <ul>
        ...
        <li>Quarterly platform reviews</li>
        <li>Custom SLA options available</li>
      </ul>
    </div>
